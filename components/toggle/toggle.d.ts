 ...
 */
export declare class Toggle extends BaseInput<boolean> implements IonicTapInput, AfterViewInit, OnDestroy {
    private _plt;
    private _haptic;
     ...
     */
    checked: boolean;
    constructor(form: Form, config: Config, _plt: Platform, elementRef: ElementRef, renderer: Renderer, _haptic: Haptic, item: Item, _gestureCtrl: GestureController, _domCtrl: DomController, _cd: ChangeDetectorRef);
    /**
     * @hidden
     */
